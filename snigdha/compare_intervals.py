...
def main(opts):
    ...
    for rho, snr, signal in product(np.atleast_1d(opts.rho),
        ...
        compare(instance,
                ...
                confidence=new_opts.confidence)
...
Try:
    python compare_intervals.py --instance bestsubset_instance --rho 0.3 --nsample 100 --nfeature 50 --nsignal 10 --methods lee_theory liu_theory --htmlfile indep.html --csvfile indep.csv
''')
